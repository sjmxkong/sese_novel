<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/data/www/sese.axs8.net/public/../application/admin/view/agent/material_edit.html";i:1478087132;s:68:"/data/www/sese.axs8.net/public/../application/admin/view/layout.html";i:1489228178;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-10">
                        <form action="<?php echo url('admin/agent/material_edit',['id'=>$mater['id']]); ?>" class="form-horizontal ajax-form" method="post" name="rule">
    						<div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select name="type">
                                        ...
                                        <option value="<?php echo $key; ?>"  <?php if($mater->type==$key): ?>selected="selected"<?php endif; ?>><?php echo $pt; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <select name="bid">
                                    ...
                                    <option value="<?php echo $book['bid']; ?>" <?php if($mater->bid == $book['bid']): ?>selected="selected"<?php endif; ?>>(<?php echo $book['bid']; ?>)<?php echo $book['bookname']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="title" id="inputtitle" value="<?php echo $mater->title; ?>" placeholder="推广标题">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputurl" class="col-sm-3 control-label">推广链接</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="url" id="inputurl" value="<?php echo $mater->url; ?>" placeholder="推广链接">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <img src="<?php echo $imgUrl; ?><?php echo $mater->pic; ?>" style="max-width:600px; max-height:200px;" id="tg" class="upload">
                                    <input type="hidden" name="tg"  value="<?php echo $mater->pic; ?>" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="inputstatus">状态</label>
                                <div class="col-sm-5">
                                    <input type="radio" name="state" id="inputischeck" <?php if($mater->state == 1): ?>checked="checked"<?php endif; ?> value="1" />正常
                                    <input type="radio" name="state" id="inputischeck" <?php if($mater->state != 1): ?>checked="checked"<?php endif; ?> value="0" />下架
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <script id="container" name="content" type="text/plain"><?php echo $mater->content; ?></script>
                                    <script>
