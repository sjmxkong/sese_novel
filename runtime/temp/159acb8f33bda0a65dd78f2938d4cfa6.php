<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/data/www/sese.axs8.net/public/../application/admin/view/upload/index.html";i:1472455398;}*/ ?>
...
$(function(argument) {
  $("#upload-input").fileinput({
      ...
      uploadUrl: "/admin/upload/index/id/<?php echo $id; ?>", // your upload server url
    ...
    $('#<?php echo $id; ?>').attr('src','<?php echo $imgUrl; ?>'+response.file);
    $("input[name='<?php echo $id; ?>']").remove();
    $('#<?php echo $id; ?>').after($('<input>',{
      type:'hidden',
      name:'<?php echo $id; ?>',
      value:response.file
    }));
  ...
  //   bootbox.hideAll();
  //   $("input[name='<?php echo $id; ?>']").remove();
  //   $('#<?php echo $id; ?>').attr('src',$(this).attr('src'));
  //   $('#<?php echo $id; ?>').after($('<input>',{
  //     type:'hidden',
  //     name:'<?php echo $id; ?>',
  //     value:$(this).data('id')
