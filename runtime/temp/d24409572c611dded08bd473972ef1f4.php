<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/data/www/sese.dushu5.com/public/../application/admin/view/index/index.html";i:1499763252;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="">dushu5管理控制台 <span class="sr-only">(current)</span></a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                	 <li class="dropdown">
                        <a href="http://m.dushu5.com/" target="_blank" class="dropdown-toggle"><span class="glyphicon glyphicon-folder-open"></span> 前台首页</a>
                    </li>
                    <li class="dropdown">
