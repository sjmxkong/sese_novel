<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/data/www/sese.dushu5.com/public/../application/admin/view/total/thour.html";i:1499763227;s:70:"/data/www/sese.dushu5.com/public/../application/admin/view/layout.html";i:1489228178;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                     <form action="<?php echo url('admin/total/thour'); ?>" method="get" style="width: 80%;float: left;" id="booksearch">
               ...
               $(function () {
                    $('#container').highcharts({
                        ...
                        xAxis: {
                            categories: ['<?php echo implode($data_thour,"','"); ?>']
                        },
                        yAxis: {
                            title: {
                                text: ''
                ...
                <div class="table-responsive">
                    <table class="table  table-bordered table-hover">
                        ...
                        <tr class="info">
                            ...
                            <th class="text-left"><?php echo $total['chapfree']; ?></th>
                            <th class="text-left"><?php echo $total['chapcost']; ?></th>
                        </tr>
                        ...
                        <tr <?php if($key%2==1): ?>class="success"<?php endif; ?>> 
                            ...
                            <td class="text-left"><?php echo $d['chapfree']; ?></td>
                            <td class="text-left"><?php echo $d['chapcost']; ?></td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                </div>
