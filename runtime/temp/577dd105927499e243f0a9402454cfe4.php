<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/data/www/sese.axs8.net/public/../application/admin/view/agent/site_add.html";i:1475322914;s:68:"/data/www/sese.axs8.net/public/../application/admin/view/layout.html";i:1489228178;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">增加广告位</div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-10">
                        <form action="<?php echo url('admin/agent/site_add',['agent_id'=>$agent['agent_id']]); ?>" class="form-horizontal ajax-form" method="post" name="agent">
                              <div class="form-group">
                                <label for="inputagent_name" class="col-sm-3 control-label">渠道名(ID:<?php echo $agent->agent_id; ?>)</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="<?php echo $agent->agent_name; ?>" name="agent_name" id="inputagent_name" disabled="disabled">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="" name="site_name" id="inputsite_name" placeholder="广告位名称">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <?php if(is_array($payType) || $payType instanceof \think\Collection): $i = 0; $__LIST__ = $payType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($i % 2 );++$i;?>
                                        <input type="radio" name="paytype" id="inputpaytype" value="<?php echo $key; ?>" /><?php echo $pt; endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="0" name="deduct" id="inputdeduct" placeholder="扣量">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="0" name="divide" id="inputdivide" placeholder="分成比例">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="1" name="price" id="inputprice" placeholder="单价">
                                </div>
                            </div> 
