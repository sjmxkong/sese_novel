<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/data/www/sese.axs8.net/public/../application/admin/view/agent/edit.html";i:1481166433;s:68:"/data/www/sese.axs8.net/public/../application/admin/view/layout.html";i:1489228178;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">编辑渠道</div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-10">
                        <form action="<?php echo url('admin/agent/edit',['agent_id'=>$agent['agent_id']]); ?>" class="form-horizontal ajax-form" method="post" name="agent">
                       	 	<input type="hidden" name="gourl" value="<?php echo $gourl; ?>">

                            <div class="form-group">
                                <label for="inputagent_name" class="col-sm-3 control-label">ID:(<?php echo $agent->agent_id; ?>),渠道名</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="<?php echo $agent->agent_name; ?>" name="agent_name" id="inputagent_name" placeholder="渠道名">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="<?php echo $agent->user_name; ?>" name="user_name" id="inputuser_name" placeholder="登录账号">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="<?php echo $agent->user_pwd; ?>" name="user_pwd" id="inputuser_pwd" placeholder="登录密码">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="<?php echo $agent->person; ?>" name="person" id="inputperson" placeholder="联系人">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="<?php echo $agent->email; ?>" name="email" id="inputemail" placeholder="联系邮箱">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="<?php echo $agent->qq; ?>" name="qq" id="inputqq" placeholder="联系QQ">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="<?php echo $agent->mobile; ?>" name="mobile" id="inputmobile" placeholder="联系手机">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="<?php echo $agent->bank; ?>" name="bank" id="inputbank" placeholder="开户银行">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="<?php echo $agent->account_name; ?>" name="account_name" id="inputuaccount_name" placeholder="开户账号">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="<?php echo $agent->account; ?>" name="account" id="inputaccount" placeholder="银行账号">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select name="author">
                                        ...
                                        <option value="<?php echo $key; ?>"  <?php if($agent->author==$key): ?>selected="selected"<?php endif; ?>><?php echo $pt; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
