<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/data/www/sese.axs8.net/public/../application/admin/view/user/edit.html";i:1472295817;s:68:"/data/www/sese.axs8.net/public/../application/admin/view/layout.html";i:1475852854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-8">
                        <form action="<?php echo url('admin/user/edit',['id'=>$userRow['id']]); ?>" class="form-horizontal ajax-form" method="post" name="user">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="role_id" id="inputrole_id" class="form-control">
                                        ...
                                        <?php if(is_array($roleRows) || $roleRows instanceof \think\Collection): $i = 0; $__LIST__ = $roleRows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['id'] == $userRow['role_id']): ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" disabled="disabled" name="email" id="inputemail" value="<?php echo $userRow['email']; ?>" placeholder="用户邮件地址"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputname" class="col-sm-3 control-label">用户姓名</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="name" id="inputname" value="<?php echo $userRow['name']; ?>" placeholder="用户姓名">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <input type="checkbox" name="status" id="inputstatus" value="1" checked="checked" />
                                    <?php else: ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="tel" value="<?php echo $userRow['tel']; ?>" id="inputtel" placeholder="联系号码">
                                </div>
                            </div>
