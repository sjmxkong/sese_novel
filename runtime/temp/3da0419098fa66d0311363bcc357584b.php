<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/data/www/sese.axs8.net/public/../application/admin/view/category/add.html";i:1472295813;s:68:"/data/www/sese.axs8.net/public/../application/admin/view/layout.html";i:1475852854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-8">
                        <form action="<?php echo url('admin/category/add'); ?>" class="form-horizontal ajax-form" method="post" name="ariclecategory">
                            <div class="form-group">
                                <label for="inputTitle" class="col-sm-3 control-label">分类名称</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="title" id="inputTitle" placeholder="分类名称">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control " name="sort" value="1" id="inputSort" placeholder="越小越靠前">
                                </div>
                            </div>
                            <div class="form-group">
