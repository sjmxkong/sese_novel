<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/data/www/sese.axs8.net/public/../application/admin/view/rule/edit.html";i:1472295815;s:68:"/data/www/sese.axs8.net/public/../application/admin/view/layout.html";i:1475852854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">菜单编辑:ID[<?php echo $ruleRow['id']; ?>]</div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-8">
                        <form action="<?php echo url('admin/rule/edit',['id'=>$ruleRow['id']]); ?>" class="form-horizontal ajax-form" method="post" name="rule">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="parent_id" id="inputparent_id" class="form-control">
                                        ...
                                        <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $ruleRow['parent_id']): ?> selected="selected" <?php endif; ?>><?php echo $vo['title']; ?></option>
                                        ...
                                        <option value="<?php echo $v['id']; ?>"  <?php if($v['id'] == $ruleRow['parent_id']): ?> selected="selected" <?php endif; ?>>------<?php echo $v['title']; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="title" id="inputTitle" value="<?php echo $ruleRow['title']; ?>" placeholder="菜单名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputName" class="col-sm-3 control-label">菜单链接</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="name" id="inputName" value="<?php echo $ruleRow['name']; ?>" placeholder="菜单链接"> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="inputIcon"> ICON图标 </label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="icon" id="inputIcon" value="<?php echo $ruleRow->getData('icon'); ?>" placeholder="ICON图标"> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="inputislink"> 是否菜单链接 </label>
                                <div class="col-sm-5">
                                    <input type="checkbox" name="islink" id="inputislink" value="1" 
                                    <?php if($ruleRow->getData('islink') == 1): ?>
                                    checked="checked" 
                                    <?php endif; ?>
                                    /> </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control " name="sort" value="<?php echo $ruleRow->getData('sort'); ?>" id="inputSort" placeholder="越小越靠前">
                                </div>
                            </div>
                            <div class="form-group">
